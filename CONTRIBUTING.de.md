...
> Hinweis: Dieses Repository enthält die **Windows-App**. Das ursprüngliche macOS-Projekt (von cmagnussen) liegt im [Original-Repository](https://github.com/cmagnussen/blitztext-app) – siehe Herkunft in der [README](README.de.md).
...
Voraussetzungen und libclang-Hinweis siehe [README.de.md](README.de.md).
